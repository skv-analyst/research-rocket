INTERVIEW_QUESTIONS = {
    ...
    3: {
        ...
        "text_template": """
            ...
            3. Поместите окончательный ответ в тег <problems>.
...
SUMMARY_QUESTIONS = {
    1: {
        ...
        "text_template": """
            ...
            2. Для раздела "Кодирование интервью:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <codes>).
            2. Для раздела "Взаимосвязи кодов:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <code_connections>).
            2. Для раздела "Группировка кодов:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <code_groups>).
            2. Для раздела "Проблемы обозначенные в интервью:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <problems>).
            2. Для раздела "Взаимосвязи обозначенных проблем:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <problem_connections>).
            2. Для раздела "Группировка обозначенных проблем:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <problem_groups>).
            2. Для раздела "Проблемы и частота их появления:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <reflections>).
            2. Для раздела "Анализ проблем:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <results>).
            2. Для раздела "Неожиданные закономерности в ответах:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <unexpected>).
            2. Для раздела "Гипотезы возникновения проблем:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <hypothesis>).
            2. Для раздела "Альтернативные объяснения проблем:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <alternatives>).
            2. Для раздела "Дополнительные исследования:" сделайте резюме всех интервью этого раздела (поместите ответ в тег <additionals>).
